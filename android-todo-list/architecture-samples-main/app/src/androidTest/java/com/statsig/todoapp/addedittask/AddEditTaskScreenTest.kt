...
package com.statsig.todoapp.addedittask
...
class AddEditTaskScreenTest {
    ...
    fun setup() {
        ...
        composeTestRule.setContent {
            AppCompatTheme {
                Surface {
                    com.statsig.android.architecture.blueprints.todoapp.addedittask.AddEditTaskScreen(
                        viewModel = com.statsig.android.architecture.blueprints.todoapp.addedittask.AddEditTaskViewModel(
                            repository,
                            SavedStateHandle()
                        ),
